...
public class CheetosHandlerTest {
    ...
    public void setUp() {
        ...
        snacks.put("Lays", new Snack("Lays", 1.20, 10)); // Additional snack for non-match scenario
        idleState = new IdleState();
        cheetosHandler = new CheetosHandler(null); // Assuming no next handler for simplicity
    ...
    public void testHandleRequestWithCheetosOutOfStock() {
        snacks.put("Cheetos", new Snack("Cheetos", 1.50, 0)); // Cheetos are out of stock
        machine.selectSnack("Cheetos");
        machine.insertMoney(1.50);
        cheetosHandler.handleRequest(machine, "Cheetos", 1.50);
